...
<div class="container mx-auto py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-8">
        <h1 class="text-3xl font-extrabold text-blue-600 mb-8">Ajouter un nouveau livre</h1>
        ...
        <form action="{{ route('livres.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex gap-4 mt-8">
                ...
                <a href="{{ route('livres.index') }}" class="bg-gray-100 text-gray-600 px-5 py-2 rounded-lg shadow hover:bg-gray-200 transition font-semibold">
                    Annuler
                </a>
            </div>
        </form>
